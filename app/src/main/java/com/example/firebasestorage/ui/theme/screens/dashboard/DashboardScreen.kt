...
import com.example.firebasestorage.navigation.ROUT_BEAUTY
import com.example.firebasestorage.navigation.ROUT_CLOTHING
import com.example.firebasestorage.navigation.ROUT_ELECTRONIC
import com.example.firebasestorage.navigation.ROUT_GROCERIES
import com.example.firebasestorage.navigation.ROUT_HOME
import com.example.firebasestorage.navigation.ROUT_PHARMACY
      ...
      Column (modifier = Modifier.padding(start = 20.dp)){
         ...
         Row {
            ...
            Card(
               ...
               Column {
                  Box (modifier = Modifier.fillMaxWidth(), contentAlignment = Alignment.Center){
                     Image(painter = painterResource(id = com.example.firebasestorage.R.drawable.clothing),
                        contentDescription ="serv" ,
                        modifier = Modifier.size(50.dp))
                  }
         ...
         Row {
            ...
            Card(modifier = Modifier.size(width = 150.dp, height = 100.dp)
               ...
               Column {
                  Box (modifier = Modifier
                     ...
                     Image(painter = painterResource(id = com.example.firebasestorage.R.drawable.home),
                        contentDescription ="serv" ,
                        modifier = Modifier.size(50.dp))
                  }
            ...
            Card(modifier = Modifier
               ...
               Column {
                  Box (modifier = Modifier.fillMaxWidth(), contentAlignment = Alignment.Center){
                     Image(painter = painterResource(id = com.example.firebasestorage.R.drawable.beauty),
                        contentDescription ="serv" ,
                        modifier = Modifier.size(50.dp))
                  }
         ...
         Row {
            ...
            Card(modifier = Modifier
               ...
               Column {
                  Box (modifier = Modifier.fillMaxWidth(), contentAlignment = Alignment.Center){
                     Image(painter = painterResource(id = com.example.firebasestorage.R.drawable.groc),
                        contentDescription ="serv" ,
                        modifier = Modifier.size(50.dp)
                           )
                  }
